...
<!-- start section -->
<?php if (get_field('ativo_contato_secao_1')): ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6 text-center text-lg-start">
                    ...
                    <div class="elements-social social-icon-style-09 mb-20px" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <div class="col-lg-5 offset-lg-1 contact-form-style-03 text-center text-lg-start" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
...
<?php if (get_field('ativo_contato_secao_2')): ?>
<!-- start section -->
    
    <?php if (get_field('imagem_contato_heading')) : ?>
        <section class="pb-0 mt-minus-50px lg-mt-0">
