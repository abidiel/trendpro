        ...
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-6 offset-xl-1 md-mt-20 sm-mt-0" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="mb-10px">
                    ...
                    <span class="text-gradient-base-color fs-15 alt-font fw-700 ls-05px text-uppercase d-inline-block align-middle"><?php echo esc_html(get_field('servico_secao1_mini_titulo')); ?></span>
                </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-3">
            <div class="col-lg-7 text-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <span class="alt-font fw-600 d-inline-block ls-1px"><?php echo esc_html(get_field('servico_secao2_mini_titulo')); ?></span>
            ...
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center" data-anime='{ "el": "childs", "rotateZ": [5, 0], "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <?php while (have_rows('servico_secao2_cards')): the_row(); ?>
                    ...
                    <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                        <div class="feature-box bg-white box-shadow-quadruple-large box-shadow-quadruple-large-hover justify-content-start overflow-hidden pt-18 pb-18 ps-14 pe-14 lg-p-12 h-100 last-paragraph-no-margin">
                            <!-- Ícone SVG -->
                            <?php
                            ...
                            <div class="feature-box-content">
                                <span class="d-inline-block alt-font text-dark-gray fw-700 mb-5px fs-18"><?php echo esc_html(get_sub_field('titulo')); ?></span>
                                <p><?php echo wp_kses_post(get_sub_field('texto')); ?></p>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-6 p-8 lg-p-5 sm-pt-30px sm-pb-30px sm-ps-20px sm-pe-20px position-relative" data-anime='{ "el": "childs", "translateY": [0, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-servico-1.svg" class="position-absolute top-minus-30px left-minus-40px w-160px opacity-case-destaque" alt="">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-servico-2.svg" class="position-absolute bottom-40px right-minus-40px w-160px opacity-case-destaque" alt="">
                    <span class="ls-2px text-uppercase text-dark-gray fw-500 lh-22 mb-15px d-block">Case em <span class="d-inline-block border-2 border-bottom border-color-transparent-base-color fw-800">destaque</span></span>
                    ...
                    ?>
                        <h3 class="fw-600 text-dark-gray alt-font ls-minus-1px w-90 xxl-w-100 mb-20px">
                ...
                ?>
                    ...
                    <div class="col-12 col-md-6 cover-background sm-h-400px" style="background-image: url(<?php echo $background_url; ?>)">
