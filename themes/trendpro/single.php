...
if (have_posts()) {
	while (have_posts()) : the_post();
		...
		<!-- start section -->
		<section class="bg-dark-gray background-position-center-top section-blog" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/demo-architecture-dotted-pattern.svg')">
			<div class="container">
				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-8 last-paragraph-no-margin" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
						<h4 class="mt-6 text-white"><?php the_title(); ?></h2>
							<p class="text-medium-gray mb-0"><?php echo get_the_date(get_option('date_format')); ?></p>
							<?php
		...
		<!-- start section -->
		<section class="bg-dark-gray background-position-center-top pt-0" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/demo-architecture-dotted-pattern.svg')">
			<div class="container">
							...
							<div class="col-12 mb-6">
								<div class="bg-nero-grey d-block d-md-flex w-100 box-shadow-extra-large align-items-center border-radius-4px p-7 sm-p-35px">
									<div class="w-140px text-center me-50px sm-mx-auto">
										...
										<a href="demo-architecture-blog.html" class="text-white fw-500 mt-20px d-inline-block lh-20"><?php the_author_posts_link(); ?></a>
									...
									<div class="w-75 sm-w-100 text-center text-md-start last-paragraph-no-margin">
										...
										<a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" class="text-white text-uppercase fs-13 ">Todos os posts de <?php the_author(); ?></a>
									</div>
								</div>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col-12 text-center elements-social social-icon-style-04">
								<ul class="medium-icon light">
									<li><a class="facebook" href="https://www.facebook.com/share.php?u=<?php echo get_permalink(); ?>" target="_blank"><i class="fa-brands fa-facebook-f"></i><span></span></a></li>
									<li><a class="twitter" href="https://www.twitter.com/share?url=<?php echo get_permalink(); ?>" target="_blank"><i class="fa-brands fa-twitter"></i><span></span></a></li>
									<li><a class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo get_permalink(); ?>" target="_blank"><i class="fa-brands fa-linkedin-in"></i><span></span></a></li>
									<li><a class="pinterest" href="https://www.pinterest.com/pin/create/button/?url=<?php echo get_permalink(); ?>" target="_blank"><i class="fa-brands fa-pinterest"></i><span></span></a></li>
								</ul>
							</div>
						</div>
		...
		<!-- end section -->
		<!-- start section -->
		<section class="bg-nero-grey overlap-height background-position-center-top" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/demo-architecture-dotted-pattern.svg')">
			<div class="container">
