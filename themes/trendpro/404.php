...
<!-- start section -->
<section class="cover-background full-screen ipad-top-space-margin md-h-550px bg-dark-gray" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/demo-architecture-dotted-pattern.svg')">
			...
			<div class="col-12 col-xl-6 col-lg-7 col-md-9 text-center text-white" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
				...
				<form id="widget-search-form-sidebar" action="<?php echo esc_url(home_url('/')); ?>" method="get">
					<div class="input-group">
						<input type="text" aria-required="true" value="<?php echo get_search_query(); ?>" name="s" class="form-control widget-search-form border-radius-0px" placeholder="Pesquisar no blog...">
